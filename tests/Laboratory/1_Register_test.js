...
Scenario("User shall be able to select Tier Plan", async (I, register) => {
  ...
  I.saveScreenshot("output/Laboratory/User shall be able to select Tier Plan.png",true)
...
Scenario(
  ...
  (I, register) => {
    ...
    I.saveScreenshot("output/Laboratory/User shall be able to provide personal information.png",true)
  }
);
...
Scenario(
  ...
  (I, register) => {
    ...
    I.saveScreenshot("output/Laboratory/User shall be able to submit personal info for registration.png",true)
  }
);
...
Scenario(
  ...
  async (I, register) => {
    pause()
    // I.amOnPage(
    //   await I.retry(2).getConfirmEmailLink(
    //     format(variable.credential.email.laboratory, {
    //       placeholder: variable.credential.email.stamp,
    //     })
    //   )
    // );
    I.saveScreenshot("output/Laboratory/User shall be able to verify provided email address.png",true)
    I.seeElementInDOM(register.assert.success);
    I.addMochawesomeContext(await I.grabCurrentUrl());
